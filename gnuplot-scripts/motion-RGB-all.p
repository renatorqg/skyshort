# gs - Gnuplot Script file for plotting all motion-RGB
# to run type gnuplot "namefile.p"

set term png size 780, 400
set output "graph-motion-RGB-0.png"
...
set term png size 780, 400
set output "graph-motion-RGB-2.png"
set key out right top
...
set term png size 780, 400
set output "graph-motion-RGB-3.png"
set key out right top
...
set term png size 780, 400
set output "graph-motion-RGB-4.png"
set key out right top
...
set term png size 780, 400
set output "graph-motion-RGB-5.png"
set key out right top
