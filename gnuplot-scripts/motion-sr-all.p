# gs - Gnuplot Script file for plotting all motion-sr
# to run type gnuplot "namefile.p"

set term png size 780, 400
set output "graph-motion-SR-0.png"
...
set term png size 780, 400
set output "graph-motion-SR-2.png"
set key out right top
...
set term png size 780, 400
set output "graph-motion-SR-3.png"
set key out right top
...
set term png size 780, 400
set output "graph-motion-SR-4.png"
set key out right top
...
set term png size 780, 400
set output "graph-motion-SR-5.png"
set key out right top
